...
function getManifest() {
    return JSON.stringify({
        ...
        "name": "AnimeVietSub",
        "version": "1.0.8",
        "baseUrl": "https://animevietsub.li",
        "iconUrl": "https://animevietsub.li/statics/default/images/logo.png",
        "isEnabled": true,
        "type": "MOVIE",
...
function getUrlList(slug, filtersJson) {
    try {
        ...
        var baseUrl = "https://animevietsub.li";
...
function getUrlSearch(keyword, filtersJson) {
    try {
        ...
        if (page === 1) {
            return "https://animevietsub.li/tim-kiem/" + cleanKeyword + "/";
        } else {
            return "https://animevietsub.li/tim-kiem/" + cleanKeyword + "/trang-" + page + ".html";
        }
    } catch (e) {
        return "https://animevietsub.li/";
    }
...
function getUrlDetail(slug) {
    ...
    return "https://animevietsub.li/phim/" + cleanSlug;
}

function getUrlCategories() { return "https://animevietsub.li"; }
function getUrlCountries() { return "https://animevietsub.li"; }
function getUrlYears() { return "https://animevietsub.li"; }
    ...
    try {
        ...
        while ((epMatch = epPattern.exec(htmlContent)) !== null) {
            ...
            if (epUrl.indexOf('http') !== 0) {
                epUrl = "https://animevietsub.li" + (epUrl.startsWith('/') ? '' : '/') + epUrl;
            }
        ...
        if (!isPlayPage && slug && slug !== "error") {
            extra = "https://animevietsub.li/phim/" + slug + "/xem-phim.html";
        }
        ...
        if (link) {
            ...
            return JSON.stringify({
                ...
                headers: {
                    ...
                    "Referer": pageUrl || "https://animevietsub.li/",
                    "Custom-Js": bypassJs
                },
                subtitles: []
            });
...
function parseEmbedResponse(htmlContent, url) {
    try {
        ...
        var referer = nextUrlMatch ? decodeURIComponent(nextUrlMatch[1]) : "https://animevietsub.li/";
