...
function parseMovieDetail(html, url) {
	...
	try {
		...
		if (flashvarsBody) {
			...
			addEp('video_alt_url3', 'video_alt_url3_text', '4K', 'hd4k');
			addEp('video_alt_url2', 'video_alt_url2_text', '1080p', 'hd1080');
			addEp('video_alt_url', 'video_alt_url_text', '720p', 'hd720');
...
// Xử lý luồng phát trả về trực tiếp định dạng ExoPlayer hiểu
