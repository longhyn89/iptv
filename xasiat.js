...
function parseMovieDetail(html, url) {
    ...
    try {
        ...
        if (flashvarsBody) {
            ...
            // Mỗi chất lượng là 1 server riêng biệt, và bên trong chỉ có đúng 1 tập duy nhất
            var addServerByQuality = function(urlKey, textKey, defaultName, slug) {
                ...
                if (vUrl && vUrl.indexOf("http") !== -1) {
                    ...
                    var serverName = getField(textKey) || defaultName;
            ...
            addServerByQuality('video_alt_url3', 'video_alt_url3_text', '4K / FHD', 'hd4k');
            addServerByQuality('video_alt_url2', 'video_alt_url2_text', '1080p', 'hd1080');
            addServerByQuality('video_alt_url', 'video_alt_url_text', 'Chất lượng cao (HD)', 'hd720');
            addServerByQuality('video_url', 'video_url_text', 'SD', 'sd');
        }
